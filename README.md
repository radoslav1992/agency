...
`TESTIMONIALS_NOTE` е бележката под заглавието. В момента тя казва открито, че част от проектите са собствени продукти на студиото — това е разликата между отзив и реклама и не бива да се маха, докато положението е такова. Когато дойдат отзиви от независими клиенти, добави ги и сложи `null`.
