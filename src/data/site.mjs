...
export const SITE = {
  ...
  email: 'info@kova.bg',
  /**
   * Служебният телефон (Zadarma, софийски номер).
   *
   * Три записа за едно и също число, защото трите се четат от различни неща:
   *
   *   `e164`  Единственият машинен вид: без интервали, без скоби и БЕЗ нулата
   *           след кода на държавата. Тя е „изход към междуградска мрежа“ и се
   *           набира само отвътре — след `+359` е грешка, която на част от
   *           телефоните просто не се свързва. Оттук идват `tel:` връзките и
   *           стойността в структурираните данни.
   *
   *   `bg`    Както го набира българин: с водещата нула, групирано по навик.
   *
   *   `en`    Както го набира човек отвън: с кода на държавата и без нулата.
   *
   * Личният номер нарочно го няма никъде на сайта.
   */
  phone: {
    e164: '+35924920201',
    display: { bg: '02 492 0201', en: '+359 2 492 0201' },
  },
  owner: {
