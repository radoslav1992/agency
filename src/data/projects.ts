...
export const PROJECTS: Project[] = [
  {
    ...
    tagline:
      'Записваш екрана си, а Routinly ти написва ръководството стъпка по стъпка, със снимки. Това, което отнемаше следобед, става за пет минути.',
  ...
  },
  {
    ...
    tagline:
      'Превръща обикновен Markdown в документи с живи диаграми и графики и ги изкарва в твоите цветове, шрифт и лого — като PDF или уеб страница.',
