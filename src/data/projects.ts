...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tagline:
      'Качваш материалите си и питаш направо тях. Отговорът идва с посочен източник, а тетрадките и общите библиотеки държат едно и също знание достъпно за целия екип или курс.',
    tags: ['AI', 'RAG', 'Собствен продукт'],
    own: true,
    alt: 'Екран от Записки с тетрадка, качени документи и отговор с посочен източник',
  },
  {
    name: 'Routinly',
